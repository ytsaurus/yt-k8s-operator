...
| `jobHttpsCertificate` _[LocalObjectReference](https://kubernetes.io/docs/reference/generated/kubernetes-api/v1.28/#localobjectreference-v1-core)_ | Job HTTPS certificate. Reference to kubernetes.io/tls secret.<br />Exposed in job environment as YT_JOB_HTTPS_CERTIFICATE_FILE YT_JOB_HTTPS_PRIVATE_KEY_FILE. |  |  |
